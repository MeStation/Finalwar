				...
				<d2p1:anyType i:type="Folder">
					<Children>
						<d2p1:anyType i:type="BurnAttributes">
							<RelativeName>BloodFloodMAPB.xml</RelativeName>
						</d2p1:anyType>
					</Children>
...
12).Firefly auto launch rockets.
...
MAKE IT FOR VS AI, ALSO SUPPORT PVP, PASTIME. SMILE. ENJOY.</Description>
				...
				<d2p1:anyType i:type="BurnFile">
					...
					<RelativeName>BloodFloodMAPB.tga</RelativeName>
				</d2p1:anyType>
			</Children>
			<IsExpanded>true</IsExpanded>
		</d2p1:anyType>
	</Children>
	<Guid>5b73dc2f-c8d4-4886-8bdf-91a8f303c1db</Guid>
